...
const EditVendorModal = ({ isOpen, onClose, vendor, onSubmit }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Edit vendor">
      <div className="mb-4">
        <h3 className="text-lg font-medium text-gray-900 mb-1">Vendor details</h3>
        <p className="text-sm text-gray-500 mb-6">Update the details below to edit the vendor</p>
      </div>

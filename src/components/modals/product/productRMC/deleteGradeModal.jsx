...
const DeleteGradeModal = ({ isOpen, onClose, product, onDelete, loading = false }) => {
        ...
        <div className="text-center">
          ...
          <div className="mb-6">
            ...
            <p className="text-base font-medium text-gray-700 leading-relaxed">
              Are you sure you want to delete "{product?.gradeSize || product?.name}" grade/size? This action is permanent and cannot be undone.
            </p>
          </div>
